...
export default function InstructorProfilePage() {
    ...
    const handleShare = async () => {
        const shareData = {
            ...
            text: `Découvrez les cours de ${instructor?.fullName} sur Ndara Afrique !`,
                ...
                <header className="flex flex-col sm:flex-row items-center gap-6 mb-12">
                    ...
                    <div className="text-center sm:text-left flex-grow">
                        <div className="flex items-center justify-center sm:justify-start gap-2">
                            <h1 className="text-4xl font-bold">{instructor.fullName}</h1>
                            {instructor.isInstructorApproved && (
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent><p>Profil vérifié</p></TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            )}
                        </div>
