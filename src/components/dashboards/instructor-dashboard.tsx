            ...
            <main className="flex-1 overflow-y-auto pt-6 px-6 space-y-8 animate-in fade-in duration-700">
                        ...
                        <Card className="bg-gradient-to-br from-[#10b981] to-[#047857] rounded-[2.5rem] p-6 border-none shadow-2xl shadow-[#10b981]/20 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-emerald-100 text-[10px] font-black uppercase tracking-[0.2em]">{t('stats.available_balance')}</span>
                                </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Card className="bg-[#1e293b] rounded-[2rem] p-5 border border-[#10b981]/20 shadow-xl active:scale-[0.98] transition-all">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <span className="text-slate-500 text-[9px] font-black uppercase tracking-widest">{t('enrollments')}</span>
                            </div>
                            <p className="text-white font-black text-2xl leading-none">{analytics.totalStudentsCount}</p>
                            <p className="text-slate-600 text-[8px] font-bold uppercase tracking-tighter mt-1.5">{t('stats.active_students')}</p>
                        </Card>
                        ...
                        <Card className="bg-[#1e293b] rounded-[2rem] p-5 border border-[#10b981]/20 shadow-xl active:scale-[0.98] transition-all">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <span className="text-slate-500 text-[9px] font-black uppercase tracking-widest">OK</span>
                            </div>
                            <p className="text-white font-black text-2xl leading-none">{analytics.successRate}%</p>
                            <p className="text-slate-600 text-[8px] font-bold uppercase tracking-tighter mt-1.5">{t('stats.completion_rate')}</p>
                        </Card>
                    </div>
                </div>
                ...
                <Card className="bg-[#1e293b] rounded-[2.5rem] p-6 border border-white/5 shadow-2xl overflow-hidden">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="font-black text-white text-xs uppercase tracking-[0.2em]">{t('stats.treasury')}</h3>
                ...
                <div className="grid grid-cols-2 gap-4 pb-12">
                    <Link href="/instructor/courses/create" className="block group active:scale-95 transition-all">
                        <Card className="bg-[#1e293b] rounded-[2rem] p-6 border border-white/5 flex flex-col items-center justify-center gap-4 shadow-xl group-hover:border-[#10b981]/30">
                            ...
                            <span className="text-white text-[10px] font-black uppercase tracking-[0.2em]">{t('manage_catalog')}</span>
                        </Card>
                    </Link>
