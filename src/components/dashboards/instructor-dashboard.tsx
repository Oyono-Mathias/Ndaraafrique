...
import type { AssignmentSubmission, Payment } from '@/lib/types';
...
export function InstructorDashboard() {
    ...
    useEffect(() => {
        ...
        // 1. Revenus totaux (Somme des paiements Completed)
        const unsubPayments = onSnapshot(
            ...
            (snap) => {
                ...
                // Calcul de la performance par titre de cours
        ...
        // 3. Devoirs en attente (status: submitted)
    ...
    return (
        <div className="flex flex-col gap-8 pb-24 bg-slate-950 min-h-screen bg-grainy">
            ...
            {/* --- CARTES STATS (STYLE ANDROID VINTAGE) --- */}
