...
import { CreditCard, Info, BookOpen, Gift, Loader2, Check, Star, AlertTriangle, MessageSquarePlus, MessageSquare, Video, PlayCircle, Lock, ChevronRight, ChevronDown, ChevronUp, Book, Globe, Clock, Users, Tv, FileText, ShoppingCart, Heart, Award, FileQuestion } from 'lucide-react';
...
const CourseQuizzesList = ({ courseId }: { courseId: string }) => {
  ...
  const quizzesQuery = useMemoFirebase(
    () => query(collection(db, `quizzes`), where('courseId', '==', courseId), orderBy('createdAt', 'desc')),
    [db, courseId]
  );
