        ...
        <nav className={cn(
            ...
            <div className="container mx-auto px-4 flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                    <Button variant="ghost" size="icon" className="text-white sm:hidden" onClick={() => router.push('/search')}>
...
const MobileCTA = ({ siteSettings }: { siteSettings: Partial<Settings['platform']> }) => {
    ...
    if (isUserLoading || user) {
        return null; // Don't show CTA if user is logged in or we're still checking
    }
