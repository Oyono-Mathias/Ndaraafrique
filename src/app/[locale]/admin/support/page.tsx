...
/**
 * @fileOverview Centre de Support Admin Ndara Afrique - Design Elite Qwen.
 * Centralise les demandes d'assistance avec une vue prioritaire et indicateurs SLA.
 */

import { TicketList } from '@/components/admin/support/TicketList';
import { LifeBuoy, Zap, Clock, ShieldCheck, Headphones } from 'lucide-react';
...
export default function AdminSupportPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-20 relative">
      ...
      {/* SLA Status Bar - Qwen Design */}
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
          <div className="bg-slate-900/60 backdrop-blur-xl border border-white/5 p-5 rounded-[2.5rem] flex items-center gap-4 shadow-xl">
