...
export default function StudentDashboardAndroid() {
  ...
  return (
    <div className="flex flex-col gap-8 pb-24 bg-slate-950 min-h-screen relative overflow-hidden bg-grainy">
      ...
      {/* --- RÉSUMÉ AMBASSADEUR (CLIC VERS PAGE DÉDIÉE) --- */}
      {isAffiliateEnabled && (
                    ...
                    <CardContent className="p-8 space-y-6">
                        <div className="flex justify-between items-start">
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Espace Ambassadeur Ndara</p>
                            </div>
                        ...
                        <div className="bg-primary/10 border border-primary/20 p-6 rounded-[2rem] flex justify-between items-center">
                            <div>
                                <p className="text-[9px] font-black text-primary uppercase tracking-[0.2em]">Solde à retirer</p>
