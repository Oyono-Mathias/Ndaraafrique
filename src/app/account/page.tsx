...
const africanCountries: Country[] = [
  { code: 'DZ', name: 'Algérie', emoji: '🇩🇿', prefix: '213', region: 'NORTH_AFRICA' },
  { code: 'AO', name: 'Angola', emoji: '🇦🇴', prefix: '244', region: 'OTHER' },
  { code: 'BJ', name: 'Bénin', emoji: '🇧🇯', prefix: '229', region: 'UEMOA' },
  { code: 'BW', name: 'Botswana', emoji: '🇧🇼', prefix: '267', region: 'SOUTHERN_AFRICA' },
  { code: 'BF', name: 'Burkina Faso', emoji: '🇧🇫', prefix: '226', region: 'UEMOA' },
  { code: 'BI', name: 'Burundi', emoji: '🇧🇮', prefix: '257', region: 'EAST_AFRICA' },
  { code: 'CV', name: 'Cabo Verde', emoji: '🇨🇻', prefix: '238', region: 'OTHER_WEST' },
  { code: 'CM', name: 'Cameroun', emoji: '🇨🇲', prefix: '237', region: 'CEMAC' },
  { code: 'CF', name: 'République centrafricaine', emoji: '🇨🇫', prefix: '236', region: 'CEMAC' },
  { code: 'TD', name: 'Tchad', emoji: '🇹🇩', prefix: '235', region: 'CEMAC' },
  { code: 'KM', name: 'Comores', emoji: '🇰🇲', prefix: '269', region: 'EAST_AFRICA' },
  { code: 'CG', name: 'Congo', emoji: '🇨🇬', prefix: '242', region: 'CEMAC' },
  { code: 'CD', name: 'RD Congo', emoji: '🇨🇩', prefix: '243', region: 'CEMAC' },
  { code: 'CI', name: 'Côte d\'Ivoire', emoji: '🇨🇮', prefix: '225', region: 'UEMOA' },
  { code: 'DJ', name: 'Djibouti', emoji: '🇩🇯', prefix: '253', region: 'EAST_AFRICA' },
  { code: 'EG', name: 'Égypte', emoji: '🇪🇬', prefix: '20', region: 'NORTH_AFRICA' },
  { code: 'GQ', name: 'Guinée équatoriale', emoji: '🇬🇶', prefix: '240', region: 'CEMAC' },
  { code: 'ER', name: 'Érythrée', emoji: '🇪🇷', prefix: '291', region: 'EAST_AFRICA' },
  { code: 'SZ', name: 'Eswatini', emoji: '🇸🇿', prefix: '268', region: 'SOUTHERN_AFRICA' },
  { code: 'ET', name: 'Éthiopie', emoji: '🇪🇹', prefix: '251', region: 'EAST_AFRICA' },
  { code: 'GA', name: 'Gabon', emoji: '🇬🇦', prefix: '241', region: 'CEMAC' },
  { code: 'GM', name: 'Gambie', emoji: '🇬🇲', prefix: '220', region: 'OTHER_WEST' },
  { code: 'GH', name: 'Ghana', emoji: '🇬🇭', prefix: '233', region: 'OTHER_WEST' },
  { code: 'GN', name: 'Guinée', emoji: '🇬🇳', prefix: '224', region: 'OTHER_WEST' },
  { code: 'GW', name: 'Guinée-Bissau', emoji: '🇬🇼', prefix: '245', region: 'UEMOA' },
  { code: 'KE', name: 'Kenya', emoji: '🇰🇪', prefix: '254', region: 'EAST_AFRICA' },
  { code: 'LS', name: 'Lesotho', emoji: '🇱🇸', prefix: '266', region: 'SOUTHERN_AFRICA' },
  { code: 'LR', name: 'Libéria', emoji: '🇱🇷', prefix: '231', region: 'OTHER_WEST' },
  { code: 'LY', name: 'Libye', emoji: '🇱🇾', prefix: '218', region: 'NORTH_AFRICA' },
  { code: 'MG', name: 'Madagascar', emoji: '🇲🇬', prefix: '261', region: 'EAST_AFRICA' },
  { code: 'MW', name: 'Malawi', emoji: '🇲🇼', prefix: '265', region: 'SOUTHERN_AFRICA' },
  { code: 'ML', name: 'Mali', emoji: '🇲🇱', prefix: '223', region: 'UEMOA' },
  { code: 'MR', name: 'Mauritanie', emoji: '🇲🇷', prefix: '222', region: 'OTHER_WEST' },
  { code: 'MU', name: 'Maurice', emoji: '🇲🇺', prefix: '230', region: 'EAST_AFRICA' },
  { code: 'MA', name: 'Maroc', emoji: '🇲🇦', prefix: '212', region: 'NORTH_AFRICA' },
  { code: 'MZ', name: 'Mozambique', emoji: '🇲🇿', prefix: '258', region: 'SOUTHERN_AFRICA' },
  { code: 'NA', name: 'Namibie', emoji: '🇳🇦', prefix: '264', region: 'SOUTHERN_AFRICA' },
  { code: 'NE', name: 'Niger', emoji: '🇳🇪', prefix: '227', region: 'UEMOA' },
  { code: 'NG', name: 'Nigéria', emoji: '🇳🇬', prefix: '234', region: 'OTHER_WEST' },
  { code: 'RW', name: 'Rwanda', emoji: '🇷🇼', prefix: '250', region: 'EAST_AFRICA' },
  { code: 'ST', name: 'Sao Tomé-et-Principe', emoji: '🇸🇹', prefix: '239', region: 'CEMAC' },
  { code: 'SN', name: 'Sénégal', emoji: '🇸🇳', prefix: '221', region: 'UEMOA' },
  { code: 'SC', name: 'Seychelles', emoji: '🇸🇨', prefix: '248', region: 'EAST_AFRICA' },
  { code: 'SL', name: 'Sierra Leone', emoji: '🇸🇱', prefix: '232', region: 'OTHER_WEST' },
  { code: 'SO', name: 'Somalie', emoji: '🇸🇴', prefix: '252', region: 'EAST_AFRICA' },
  { code: 'ZA', name: 'Afrique du Sud', emoji: '🇿🇦', prefix: '27', region: 'SOUTHERN_AFRICA' },
  { code: 'SS', name: 'Soudan du Sud', emoji: '🇸🇸', prefix: '211', region: 'EAST_AFRICA' },
  { code: 'SD', name: 'Soudan', emoji: '🇸🇩', prefix: '249', region: 'NORTH_AFRICA' },
  { code: 'TZ', name: 'Tanzanie', emoji: '🇹🇿', prefix: '255', region: 'EAST_AFRICA' },
  { code: 'TG', name: 'Togo', emoji: '🇹🇬', prefix: '228', region: 'UEMOA' },
  { code: 'TN', name: 'Tunisie', emoji: '🇹🇳', prefix: '216', region: 'NORTH_AFRICA' },
  { code: 'UG', name: 'Ouganda', emoji: '🇺🇬', prefix: '256', region: 'EAST_AFRICA' },
  { code: 'ZM', name: 'Zambie', emoji: '🇿🇲', prefix: '260', region: 'SOUTHERN_AFRICA' },
  { code: 'ZW', name: 'Zimbabwe', emoji: '🇿🇼', prefix: '263', region: 'SOUTHERN_AFRICA' },
